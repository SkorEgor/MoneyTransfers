...
Читает файл с д
* Чтение файла в динамический массив, состоящий из восьми элементов типа ORDER;
* Упорядочить объекты по возрастанию расчетного счета плательщик;
* Ввывод на экран информции о сумме, снятой с расчетного счета плательщика,
